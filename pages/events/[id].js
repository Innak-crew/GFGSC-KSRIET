  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`https://gfgsc-KSRIET.vercel.app/events/${event?.id}`} />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="GFGSC-KSRIET" />

        {/*// Twitter*/}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@gfgsc_KSRIET" />
        <meta name="twitter:creator" content="@gfgsc_KSRIET" />
        ...
        {/*// Facebook*/}
        <meta property="fb:app_id" content="GFGSC-KSRIET" />
        <meta property="og:url" content={`https://gfgsc-KSRIET.vercel.app/events${event?.id}`} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content={event?.title} />
        <meta property="og:description" content={event?.description} />
